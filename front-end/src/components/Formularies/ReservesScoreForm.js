...
export default function ReservesScoreForm({
  ...
  async function performSubmit(e) {
    ...
    try {
      ...
      const route = `${host}/api/reserves/rate/?id=${reservations[index].id}`;
        ...
        <fieldset>
          <div className="form-element form-input">
            <textarea
              ...
              onChange={(event) => handleOnChange(event, 'comentario_usuario')}
              maxLength="1000"
              rows="3"
            ...
            <label className="form-element-label" htmlFor="comentario_usuario">
              Comentarios
            </label>
          </div>
          ...
          <label htmlFor="puntuacion_usuario">
            ...
            <select
              ...
              onChange={(event) => handleOnChange(event, 'puntuacion_usuario')}
              required
            >
