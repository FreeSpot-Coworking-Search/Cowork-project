...
export default function ModificationFormCenter({
    ...
    async function deleteCenter() {
        ...
        try {
            ...
            const route = `${getHost()}/api/centers/?id=${center.id}`;
    ...
    return (
        <>
            ...
            >
                <fieldset>
                    ...
                    <div class="form-element form-input">
                        <input
                            ...
                            required
                            onChange={(event) =>
                                handleOnChange(event, 'nombre_fiscal')
                            }
                            maxLength="50"
                            minLength="1"
                    ...
                    <div class="form-element form-input">
                        <input
                            ...
                            type="text"
                            onChange={(event) =>
                                handleOnChange(event, 'direccion')
                            }
                            maxLength="50"
                            minLength="1"
                    ...
                    <div class="form-element form-input">
                        <input
                            ...
                            type="text"
                            onChange={(event) =>
                                handleOnChange(event, 'localidad')
                            }
                            maxLength="70"
                            minLength="1"
                    ...
                    <div class="form-element form-input">
                        <input
                            ...
                            onChange={(event) =>
                                handleOnChange(event, 'codigo_postal')
                            }
                            maxLength="5"
                            minLength="5"
                    ...
                    <div class="form-element form-input">
                        <textarea
                            ...
                            onChange={(event) =>
                                handleOnChange(event, 'equipamiento')
                            }
                            maxLength="1000"
                            rows="3"
                ...
                <button onClick={(e) => performSubmit(e)}>Enviar</button>
                <button
                    onClick={(e) => {
                        e.preventDefault();
                        handleClickOpen();
            ...
            <Dialog open={open} onClose={handleClose}>
                <div className="modificationForm-dialog">
                    ...
                    <button onClick={deleteCenter} disabled={disabled}>
                        Eliminar
                    </button>
